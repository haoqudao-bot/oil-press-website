﻿﻿﻿﻿export const frProductBodiesA: Record<string, string> = {
...
La HN325 est idéal pour presser une grande variété de graines oléagineuses conventionnelles :
...
- **Fiabilité Éprouvée** — En tant que modèle populaire, la HN325 a été testé sur le terrain sur des milliers d'installations avec un historique de performances fiables.
...
La HN355 excelle avec les graines oléagineuses conventionnelles et les matières qui bénéficient d'une force de pressage supérieure :

- **Graines Oléagineuses** : Graine de thé, colza, arachide, soja, lin, graine de laque
- **Matières Plus Dures** : Graines et matières légèrement plus dures que la HN325 peut ne pas extraire complètement en une seule passe
...
- **Performances Équilibrées** — Positionnée entre la HN426 et la HN500, offrant une forte force de pressage sans la prime du modèle phare.
...
La HN300 est idéal pour presser le sésame et autres petites graines oléagineuses :
...
La Presse à Huile Hydraulique Moyenne HN400 comble le fossé entre nos modèles standard et de pressage à froid, offrant 500 tonnes de force de pressage avec une pression superficielle du gâteau de 38 Mpa/cm². Cette machine polyvalente est adaptée au pressage à froid et fonctionne efficacement en toutes saisons sans être limitée par les conditions climatiques. Que vous traitiez des graines oléagineuses conventionnelles ou que vous vous lanciez dans la production de pressage à froid, la HN400 offre la puissance et la flexibilité dont vous avez besoin.
...
La HN400 est idéal pour presser une grande variété de graines oléagineuses conventionnelles et semi-dures :
...
- **Polyvalence de Pressage à Froid** — Nous comprenons les exigences tant de la production conventionnelle que du pressage à froid et avons conçu la HN400 pour exceller dans les deux.
- **Assurance Qualité** — Chaque machine subit des tests rigoureux avant l'expédition, y compris des tests de pression hydraulique en pleine charge et la vérification des cycles opérationnels.
- **Support Après-Vente** — Support technique complet, disponibilité des pièces de rechange et assistance de dépannage à distance pour maintenir le bon fonctionnement de votre installation.
- **Options de Personnalisation** — Les dimensions du fût, la longueur de course et d'autres paramètres peuvent être personnalisés pour correspondre à vos exigences spécifiques en matière de matières et de production.`,
...
- **Fût à Fentes de Type Barre** — Surface d'extraction d'huile nettement supérieure aux fûts percés, atteignant environ 2 à 3 % de rendement en huile plus élevé (sur la base de tests internes, les résultats peuvent varier) par lot, désormais en acier inoxydable de qualité alimentaire.
- **Système Hydraulique Allemand** — Pompe combinée ultra-haute pression délivrant une pression de service jusqu'à 60 Mpa pour une extraction constante et puissante.
- **Retrait du Gâteau à 4 Crochets** — Système de déchargement du gâteau facile et fiable qui réduit les temps d'arrêt entre les cycles de pressage.
- **Cadre en Acier à Haut Carbone** — Longue durée de service sous fonctionnement continu. La durée de service réelle dépend des conditions de fonctionnement et de l'entretien.
- **Contrôle par Micro-ordinateur** — Cycle de pressage automatisé avec fonctionnement à un bouton. Formation de base recommandée ; nous fournissons des tutoriels vidéo et un accompagnement à distance.
- **Économe en Énergie** — Conçu pour réduire la consommation électrique par rapport aux presses de génération précédente (les économies réelles varient selon les conditions de fonctionnement).
